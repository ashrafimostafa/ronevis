...
import com.mostafa.tool.ronevis.util.doOnBackgroundThread
...
class CanvasView(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    public override fun onSaveInstanceState(): Parcelable {
        ...
        val savedState = CustomParcelable(superState!!)
    ...
    fun setBrushSize(newBrushSize: Float) {
        ...
        mPaintOptions.strokeWidth =
            resources.getDimension(R.dimen.full_brush_size) * (newBrushSize / mScaleFactor / 100f)
    }
